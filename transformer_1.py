...
if __name__ == '__main__':
	...
	# model parameters
	model_kwargs = {'input_size': data.data.shape[-1],
	...
	if task == 'S/F binary classification':
		...
		y = np.array(np.log10(data.obs.kcat) > -16.02, dtype=int)
	...
	for i, (train_idx, test_idx) in enumerate(splits):
		...
		cv_fold = i+1
		fold = Fold(cv_fold, train_idx, test_idx, parallel_folds,
		...
		if parallel_folds:
			...
			# processes.append(pool.apply_async(time.sleep, (10,)))
		else:
			fold.run()
			# time.sleep(10)
