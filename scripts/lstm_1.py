...
goal of this script is to train an LSTM-based model that predicts 
the k_cat for a given mutant based on a sampled set of its trajectories.

METHOD:
This script implements a standard LSTM encoder, specialized 
	...
	for i, (trainset, testset) in enumerate(splits):
		...
		if split_by_variant:
			...
			fold = Fold(cv_fold, traindata, testdata, parallel_folds,
                        ...
                        random_seed, batch_size, cv_folds, model_type='LSTM encoder',
